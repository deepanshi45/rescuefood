...
import com.example.login.model.Notification;
import com.example.login.model.NotificationType;
...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    // Filter by actual enum types
    List<Notification> findByRecipientUsernameAndTypeOrderByCreatedAtDesc(String username, NotificationType type);
